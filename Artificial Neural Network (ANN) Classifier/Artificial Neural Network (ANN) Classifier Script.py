...
model.add(Dense(8, activation = 'relu'))                                                 #Can I change neurons or just because neurons means dimension so it si fixed?          
model.add(Dense(1))                                                      
# Compile model
model.compile(loss='mean_squared_error', 
              optimizer='adam', metrics=['mse', 'mae','acc'])
...
estimator = model.fit(X, Y, epochs=5, verbose=1)                                     #The meaning of adding batch size here?
